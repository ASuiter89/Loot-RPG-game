...
export const SHRINE_DEFS = {
  ...
  power:   { name: 'Shrine of Power',   icon: 'ui_power', flash: '#ff6600', floors: 3, weight: 5, classic: true,
             desc: '+50% damage.',                 log: 'Shrine of Power! +50% damage for 3 floors.' },
  guard:   { name: 'Shrine of Warding', icon: 'a_shield', flash: '#3366ff', floors: 3, weight: 5, classic: true,
             desc: 'Take 40% less damage.',         log: 'Shrine of Warding! Incoming damage −40% for 3 floors.' },
  fortune: { name: 'Shrine of Fortune', icon: 'ic_money', flash: '#22cc66', floors: 3, weight: 5, classic: true,
             desc: '+50% loot and an extra drop.',  log: 'Shrine of Fortune! Better loot for 3 floors.' },
  blood:   { name: 'Blood Shrine',      icon: 'ic_heart', flash: '#cc0000', weight: 4, classic: true, instant: true,
             desc: 'Trade current HP for a burst of XP.' },
  wisdom:  { name: 'Shrine of Wisdom',  icon: 'scroll',   flash: '#aa66ff', weight: 4, classic: true, instant: true,
             desc: 'Restores HP and refills MP.' },

  // ── New boons — generic buff pipeline via shrineFx() ──
  greed:     { name: 'Shrine of Greed',      icon: 'ic_coffer',  flash: '#ffcf52', floors: 3, weight: 1, fx: { goldPct: 0.6 },
               desc: '+60% gold found.',            log: 'Shrine of Greed! +60% gold for 3 floors.' },
  insight:   { name: 'Shrine of Insight',    icon: 'ui_level',   flash: '#6ec1ff', floors: 3, weight: 1, fx: { xpPct: 0.5 },
               desc: '+50% experience gained.',     log: 'Shrine of Insight! +50% XP for 3 floors.' },
  discovery: { name: 'Shrine of Discovery',  icon: 'mat_glimmer', flash: '#d78bff', floors: 3, weight: 1, fx: { magicPct: 0.5 },
               desc: '+50 Magic Find (rarer drops).', log: 'Shrine of Discovery! +50 Magic Find for 3 floors.' },
  harvest:   { name: 'Shrine of Harvest',    icon: 'mat_core',   flash: '#8fd694', floors: 3, weight: 1, fx: { matPct: 0.6 },
               desc: '+60% crafting materials.',    log: 'Shrine of Harvest! +60% materials for 3 floors.' },
  precision: { name: 'Shrine of Precision',  icon: 'ic_target',  flash: '#ff9a3c', floors: 3, weight: 1, fx: { critPct: 0.18 },
               desc: '+18% critical-hit chance.',   log: 'Shrine of Precision! +18% crit for 3 floors.' },
  phantom:   { name: 'Shrine of the Phantom', icon: 'a_hands',   flash: '#9fb4d6', floors: 3, weight: 1, fx: { dodgePct: 0.15 },
               desc: '+15% chance to dodge.',       log: 'Shrine of the Phantom! +15% dodge for 3 floors.' },
  sorcery:   { name: 'Shrine of Sorcery',    icon: 'ic_wand',    flash: '#b08ad8', floors: 3, weight: 1, fx: { spellUp: 0.3, skillUp: 0.3 },
               desc: '+30% skill & spell power.',   log: 'Shrine of Sorcery! +30% ability power for 3 floors.' },
  leech:     { name: 'Shrine of the Leech',  icon: 'ic_cursed',  flash: '#cc3355', floors: 3, weight: 1, fx: { lifesteal: 0.15 },
               desc: 'Heal for 15% of damage dealt.', log: 'Shrine of the Leech! +15% lifesteal for 3 floors.' },
  thorns:    { name: 'Shrine of Brambles',   icon: 'ic_mallet',  flash: '#7fae5f', floors: 3, weight: 1, fx: { thornsLvl: 4 },
               desc: 'Reflect damage at attackers.', log: 'Shrine of Brambles! Reflect damage for 3 floors.' },
  renewal:   { name: 'Shrine of Renewal',    icon: 'ic_heart',   flash: '#55dd77', floors: 3, weight: 1, fx: { regenPctHp: 0.01 },
               desc: 'Steadily regenerate HP.',     log: 'Shrine of Renewal! Regenerate HP for 3 floors.' },
  clarity:   { name: 'Shrine of Clarity',    icon: 'ic_orb',     flash: '#59b6ff', floors: 3, weight: 1, fx: { mpRegenPctMp: 0.02 },
               desc: 'Steadily regenerate MP.',     log: 'Shrine of Clarity! Regenerate MP for 3 floors.' },
  bulwark:   { name: 'Shrine of the Bulwark', icon: 'a_chest',   flash: '#6688cc', floors: 3, weight: 1, fx: { defLvl: 2 },
               desc: 'Bolstered Defense.',          log: 'Shrine of the Bulwark! +Defense for 3 floors.' },
  swift:     { name: 'Shrine of Swiftness',  icon: 'ui_agility', flash: '#7fe0d0', floors: 3, weight: 1, fx: { movePct: 0.18 },
               desc: '+18% move speed.',            log: 'Shrine of Swiftness! +18% move speed for 3 floors.' },
  haste:     { name: 'Shrine of Haste',      icon: 'w_dagger',   flash: '#ffd24b', floors: 3, weight: 1, fx: { atkSpdPct: 0.25 },
               desc: '+25% attack speed.',          log: 'Shrine of Haste! +25% attack speed for 3 floors.' },
  vigor:     { name: 'Shrine of Vigor',      icon: 'potion_g',   flash: '#ffb14a', floors: 3, weight: 1, stamina: true, fx: {},
