...
const DEFS = [
  ...
  { id: 'titanfell', base: 'Greatsword', name: 'Titanfell', cls: 'warrior', native: 'CLEAVE',
    mods: [s('ATK'), s('IDMG'), s('HP'), s('PEN'), s('CDR'), a('might')], powers: ['giantsbane', 'cleaving', 'piercing'],
  ...
  { id: 'wyrmreach', base: 'Pike', name: 'Wyrmreach, the Skypiercer', cls: 'warrior', native: 'PEN',
    mods: [s('ATK'), s('ACC'), s('CRIT'), s('CRITDMG'), s('SKILLPWR'), a('agility')], powers: ['giantsbane', 'rending', 'piercing'],
  ...
  { id: 'astralNeedle', base: 'Wand', name: 'The Astral Needle', cls: 'mage', native: 'CRITDMG',
    mods: [s('SPELLPWR'), s('CRIT'), s('CASTSPD'), s('MP'), s('MAGICPEN'), a('luck')], powers: ['arcing', 'spellbound', 'caroming'],
  ...
  { id: 'stormfletch', base: 'Shortbow', name: 'Stormfletch', cls: 'rogue', native: 'ATKSPD',
    mods: [s('DBLSTRIKE'), s('CRIT'), s('ACC'), s('SPD'), s('DODGE'), a('agility')], powers: ['flurry', 'frenzied', 'volleying'],
  ...
  { id: 'horizonfall', base: 'Longbow', name: 'Horizonfall', cls: 'rogue', native: 'BOSSDMG',
    mods: [s('CRITDMG'), s('CRIT'), s('PEN'), s('EXEC'), s('IDMG'), a('agility')], powers: ['deadeye', 'giantsbane', 'piercing'],
  ...
  { id: 'cinderCodex', base: 'Tome', name: 'The Cinder Codex', cls: 'mage', native: 'IDMG',
    mods: [s('CRIT'), s('CDR'), s('MP'), s('MPLEECH'), s('BOSSDMG'), a('spirit')], powers: ['spellbound', 'brutal', 'rebounding'],
  ...
  { id: 'neverspent', base: 'Quiver', name: 'Neverspent', cls: 'rogue', native: 'DBLSTRIKE',
    mods: [s('ATKSPD'), s('CRIT'), s('ACC'), s('PEN'), s('IDMG'), a('agility')], powers: ['flurry', 'frenzied', 'volleying'],
