...
// always carries the same `native` signature stat and the same six `mods`, plus its
// PRIMARY signature power (a "legendary modifier" like Vampiric) and a chance at a
// SECOND one. On drop it rolls how many powers it carries: 1 (~67%) or 2
// (~33%) — never 3 — keeping the primary always and adding the secondary at
// UNIQUE_SECOND_POWER_CHANCE (see rollUniquePowers). The numeric VALUES and that
// power roll are settled once at drop, scaled to depth, then LOCK (see buildUnique +
// isFixedItem in src/legacy/game.js). Pure data — no logic here.
//
// Each entry:
...
//   powers  EXACTLY two distinct signature power keys (see ITEM_POWERS in
//           src/legacy/game.js): [0] is the PRIMARY (always granted, mirrored onto a
//           derived `power` field for back-compat); [1] is the SECONDARY, granted
//           only on the ~33% of drops that roll a second power. Caster items only
//           carry caster-lane powers (never Warmage/Frenzied); martial items never
//           carry Spellbound/Quickened.
...
// Chance a dropped unique/Mythic carries its SECOND signature power (its first is
// always granted). ~33% get two powers, ~67% get one — never three. Rolled once on
// drop then locked (see rollUniquePowers + buildFixedArtifact). Tuning value only.
export const UNIQUE_SECOND_POWER_CHANCE = 0.33;
...
const DEFS = [
  ...
  { id: 'sixteenCuts', base: 'Shortsword', name: 'Sixteen Cuts', cls: 'rogue', native: 'DBLSTRIKE',
    mods: [s('ATKSPD'), s('LEECH'), s('ACC'), s('DODGE'), s('BLEED'), a('agility')], powers: ['duelist', 'flurry'],
  ...
  { id: 'theEvenHand', base: 'Arming Sword', name: 'The Even Hand', cls: 'templar', native: 'DR',
    mods: [s('ATK'), s('CRIT'), s('HP'), s('CDR'), s('ACC'), a('might')], powers: ['warlord', 'tenacious'],
  ...
  { id: 'theLastCourtesy', base: 'Rapier', name: 'The Last Courtesy', cls: 'rogue', native: 'PEN',
    mods: [s('CRIT'), s('CRITDMG'), s('ACC'), s('DODGE'), s('ATKSPD'), a('agility')], powers: ['executioner', 'rending'],
  ...
  { id: 'titanfell', base: 'Greatsword', name: 'Titanfell', cls: 'warrior', native: 'CLEAVE',
    mods: [s('ATK'), s('IDMG'), s('HP'), s('PEN'), s('CDR'), a('might')], powers: ['giantsbane', 'cleaving'],
  ...
  { id: 'crescentfall', base: 'Claymore', name: 'Crescentfall', cls: 'warrior', native: 'LEECH',
    mods: [s('CRITDMG'), s('EXEC'), s('CRIT'), s('ATK'), s('HPKILL'), a('might')], powers: ['reckless', 'bloodthirsty'],
  ...
  { id: 'twinbite', base: 'Hatchet', name: 'Twinbite', cls: 'warrior', native: 'DBLSTRIKE',
    mods: [s('ATKSPD'), s('CRIT'), s('CRITDMG'), s('ACC'), s('DODGE'), a('agility')], powers: ['vampiric', 'flurry'],
  ...
  { id: 'bloodmarch', base: 'War Axe', name: 'Bloodmarch', cls: 'warrior', native: 'HPKILL',
    mods: [s('CLEAVE'), s('ATK'), s('BLEED'), s('DR'), s('THORNS'), a('might')], powers: ['brutal', 'cleaving'],
  ...
  { id: 'worldrender', base: 'Greataxe', name: 'Worldrender', cls: 'warrior', native: 'CLEAVE',
    mods: [s('BOSSDMG'), s('CRITDMG'), s('PEN'), s('STUNPWR'), s('CDR'), a('might')], powers: ['reckless', 'giantsbane'],
  ...
  { id: 'gallowsedge', base: 'Battleaxe', name: 'Gallowsedge', cls: 'warrior', native: 'EXEC',
    mods: [s('CRIT'), s('ACC'), s('ATK'), s('SKILLPWR'), s('HP'), a('luck')], powers: ['savage', 'executioner'],
  ...
  { id: 'flickerfang', base: 'Dagger', name: 'Flickerfang', cls: 'rogue', native: 'DBLSTRIKE',
    mods: [s('CRIT'), s('CRITDMG'), s('ATKSPD'), s('SKILLPWR'), s('LEECH'), a('agility')], powers: ['arcing', 'flurry'],
  ...
  { id: 'coldwhisper', base: 'Stiletto', name: 'Coldwhisper', cls: 'rogue', native: 'PEN',
    mods: [s('CRIT'), s('CRITDMG'), s('ACC'), s('DODGE'), s('SPD'), a('agility')], powers: ['executioner', 'deadeye'],
  ...
  { id: 'sanguemourn', base: 'Kris', name: 'Sanguemourn', cls: 'mage', native: 'MP',
    mods: [s('LEECH'), s('BLEED'), s('MPKILL'), s('HPKILL'), s('MCR'), a('spirit')], powers: ['siphoning', 'vampiric'],
  ...
  { id: 'vesperToll', base: 'Mace', name: 'Vesper, Toll of the Faithful', cls: 'templar', native: 'REGEN',
    mods: [a('vitality'), s('DEF'), s('DR'), s('HP'), s('STUNPWR'), s('SKILLPWR')], powers: ['bulwark', 'stalwart'],
  ...
  { id: 'sanguineCrown', base: 'Morningstar', name: 'The Deposer', cls: 'warrior', native: 'BOSSDMG',
    mods: [a('might'), s('PEN'), s('IDMG'), s('CRITDMG'), s('DBLSTRIKE'), s('LEECH')], powers: ['executioner', 'giantsbane'],
  ...
  { id: 'cataclast', base: 'Maul', name: 'Cataclast', cls: 'warrior', native: 'CLEAVE',
    mods: [a('might'), s('ATK'), s('IDMG'), s('HP'), s('TENAC'), s('SKILLPWR')], powers: ['concussive', 'cleaving'],
  ...
  { id: 'dawnwardVigil', base: 'Spear', name: 'Dawnward, the Endless Vigil', cls: 'templar', native: 'DR',
    mods: [s('ATK'), s('ACC'), s('CRIT'), s('BLOCK'), s('SKILLPWR'), a('vitality')], powers: ['arcing', 'warded'],
  ...
  { id: 'grimtollTithe', base: 'Halberd', name: 'Grimtoll, the Reaping Tithe', cls: 'warrior', native: 'EXEC',
    mods: [s('ATK'), s('IDMG'), s('CRITDMG'), s('BLEED'), s('ATKSPD'), a('might')], powers: ['cleaving', 'executioner'],
  ...
  { id: 'wyrmreach', base: 'Pike', name: 'Wyrmreach, the Skypiercer', cls: 'warrior', native: 'PEN',
    mods: [s('ATK'), s('ACC'), s('CRIT'), s('CRITDMG'), s('SKILLPWR'), a('agility')], powers: ['giantsbane', 'rending'],
  ...
  { id: 'raveningFont', base: 'Staff', name: 'The Ravening Font', cls: 'mage', native: 'MP',
    mods: [s('SPELLPWR'), s('MPLEECH'), s('CASTSPD'), s('REGEN'), s('CDR'), a('spirit')], powers: ['vampiric', 'spellbound'],
  ...
  { id: 'astralNeedle', base: 'Wand', name: 'The Astral Needle', cls: 'mage', native: 'CRITDMG',
    mods: [s('SPELLPWR'), s('CRIT'), s('CASTSPD'), s('MP'), s('MAGICPEN'), a('luck')], powers: ['arcing', 'spellbound'],
  ...
  { id: 'stormfletch', base: 'Shortbow', name: 'Stormfletch', cls: 'rogue', native: 'ATKSPD',
    mods: [s('DBLSTRIKE'), s('CRIT'), s('ACC'), s('SPD'), s('DODGE'), a('agility')], powers: ['flurry', 'frenzied'],
  ...
  { id: 'horizonfall', base: 'Longbow', name: 'Horizonfall', cls: 'rogue', native: 'BOSSDMG',
    mods: [s('CRITDMG'), s('CRIT'), s('PEN'), s('EXEC'), s('IDMG'), a('agility')], powers: ['deadeye', 'giantsbane'],
  ...
  { id: 'reaptide', base: 'Scythe', name: 'Reaptide', cls: 'warrior', native: 'EXEC',
    mods: [s('LEECH'), s('HPKILL'), s('CRIT'), s('PEN'), s('IDMG'), a('might')], powers: ['reckless', 'executioner'],
  ...
  { id: 'ranksunder', base: 'War Scythe', name: 'Ranksunder', cls: 'warrior', native: 'CLEAVE',
    mods: [s('LEECH'), s('HPKILL'), s('ATK'), s('SKILLPWR'), s('TENAC'), a('vitality')], powers: ['warlord', 'cleaving'],
  ...
  { id: 'quickguard', base: 'Buckler', name: 'Quickguard', cls: 'templar', native: 'THORNS',
    mods: [s('DR'), s('HP'), s('DODGE'), s('TENAC'), s('REGEN'), a('vitality')], powers: ['evasive', 'thornmail'],
  ...
  { id: 'oathkeeper', base: 'Kite Shield', name: 'Oathkeeper', cls: 'templar', native: 'HP',
    mods: [s('DR'), s('THORNS'), s('TENAC'), s('REGEN'), s('SKILLPWR'), a('vitality')], powers: ['aegis', 'tenacious'],
  ...
  { id: 'mountainhold', base: 'Tower Shield', name: 'Mountainhold', cls: 'templar', native: 'DR',
    mods: [s('HP'), s('THORNS'), s('TENAC'), s('STUNPWR'), s('HPKILL'), a('vitality')], powers: ['ironhide', 'warded'],
  ...
  { id: 'cinderCodex', base: 'Tome', name: 'The Cinder Codex', cls: 'mage', native: 'IDMG',
    mods: [s('CRIT'), s('CDR'), s('MP'), s('MPLEECH'), s('BOSSDMG'), a('spirit')], powers: ['spellbound', 'brutal'],
  ...
  { id: 'theStillEye', base: 'Focus', name: 'The Still Eye', cls: 'mage', native: 'CASTSPD',
    mods: [s('CDR'), s('MCR'), s('MP'), s('MPLEECH'), s('REGEN'), a('spirit')], powers: ['siphoning', 'quickened'],
  ...
  { id: 'neverspent', base: 'Quiver', name: 'Neverspent', cls: 'rogue', native: 'DBLSTRIKE',
    mods: [s('ATKSPD'), s('CRIT'), s('ACC'), s('PEN'), s('IDMG'), a('agility')], powers: ['flurry', 'frenzied'],
  ...
  { id: 'theContrary', base: 'Parrying Dagger', name: 'The Contrary', cls: 'rogue', native: 'DODGE',
    mods: [s('CRIT'), s('CRITDMG'), s('ACC'), s('DBLSTRIKE'), s('PEN'), a('agility')], powers: ['duelist', 'evasive'],
  ...
  { id: 'ironbrow', base: 'Helm', name: 'Ironbrow', cls: 'warrior', native: 'DR',
    mods: [s('HP'), s('TENAC'), s('THORNS'), s('REGEN'), s('BLOCK'), a('vitality')], powers: ['stalwart', 'warded'],
  ...
  { id: 'findersCap', base: 'Cap', name: 'Finder\'s Cap', cls: 'any', native: 'MAGICFIND',
    mods: [s('GOLDFIND'), s('XPGAIN'), s('MATFIND'), s('CRIT'), s('SPD'), a('luck')], powers: ['fortunate', 'prospector'],
  ...
  { id: 'sunlitDiadem', base: 'Crown', name: 'The Sunlit Diadem', cls: 'mage', native: 'SPELLPWR',
    mods: [s('MP'), s('CDR'), s('CASTSPD'), s('CRITDMG'), s('MCR'), a('spirit')], powers: ['attuned', 'spellbound'],
  ...
  { id: 'nightface', base: 'Hood', name: 'Nightface', cls: 'rogue', native: 'DODGE',
    mods: [s('CRIT'), s('CRITDMG'), s('SPD'), s('ACC'), s('PEN'), a('agility')], powers: ['keen', 'evasive'],
  ...
  { id: 'theClearMind', base: 'Circlet', name: 'The Clear Mind', cls: 'mage', native: 'CDR',
    mods: [s('CASTSPD'), s('MCR'), s('MP'), s('MPLEECH'), s('CRITDMG'), a('spirit')], powers: ['focused', 'hasty'],
  ...
  { id: 'bramblecoat', base: 'Cuirass', name: 'The Bramblecoat', cls: 'warrior', native: 'THORNS',
    mods: [s('IDMG'), s('HP'), s('DR'), s('TENAC'), s('STUNPWR'), a('might')], powers: ['aegis', 'thornmail'],
  ...
  { id: 'juggernautMail', base: 'Mail', name: 'Juggernaut', cls: 'warrior', native: 'TENAC',
    mods: [s('HP'), s('DR'), s('IDMG'), s('HPKILL'), s('STUNPWR'), a('might')], powers: ['brutal', 'tenacious'],
  ...
  { id: 'ghostleather', base: 'Tunic', name: 'Ghostleather', cls: 'rogue', native: 'DODGE',
    mods: [s('SPD'), s('HP'), s('REGEN'), s('CRIT'), s('ACC'), a('agility')], powers: ['fleet', 'evasive'],
  ...
  { id: 'tidefoldMantle', base: 'Robe', name: 'The Tidefold Mantle', cls: 'mage', native: 'MP',
    mods: [s('SPELLPWR'), s('CDR'), s('CASTSPD'), s('MCR'), s('REGEN'), a('spirit')], powers: ['spellbound', 'attuned'],
  ...
  { id: 'crushgrip', base: 'Gauntlets', name: 'Crushgrip', cls: 'warrior', native: 'STUNPWR',
    mods: [s('IDMG'), s('HP'), s('BLOCK'), s('CRIT'), s('PEN'), a('might')], powers: ['brutish', 'concussive'],
  ...
  { id: 'thirstingCuffs', base: 'Bracers', name: 'The Thirsting Cuffs', cls: 'any', native: 'LEECH',
    mods: [s('HP'), s('HPKILL'), s('IDMG'), s('CRIT'), s('DR'), a('vitality')], powers: ['mending', 'bloodthirsty'],
  ...
  { id: 'hairtrigger', base: 'Grips', name: 'Hairtrigger', cls: 'rogue', native: 'CRITDMG',
    mods: [s('CRIT'), s('DBLSTRIKE'), s('ACC'), s('PEN'), s('SKILLPWR'), a('agility')], powers: ['keen', 'savage'],
  ...
  { id: 'spellweaversGloves', base: 'Gloves', name: 'The Weaver\'s Ten', cls: 'mage', native: 'CDR',
    mods: [s('CASTSPD'), s('MCR'), s('SPELLPWR'), s('MP'), s('CRITDMG'), a('spirit')], powers: ['quickened', 'hasty'],
  ...
  { id: 'rootstride', base: 'Greaves', name: 'Rootstride', cls: 'templar', native: 'REGEN',
    mods: [s('HP'), s('DR'), s('TENAC'), s('HPKILL'), s('BLOCK'), a('vitality')], powers: ['tenacious', 'mending'],
  ...
  { id: 'victorsWeight', base: 'Tassets', name: 'The Victor\'s Weight', cls: 'warrior', native: 'HPKILL',
    mods: [s('IDMG'), s('HP'), s('MPKILL'), s('CRIT'), s('ATK'), a('might')], powers: ['warlord', 'brutish'],
  ...
  { id: 'windstep', base: 'Trousers', name: 'Windstep', cls: 'rogue', native: 'SPD',
    mods: [s('DODGE'), s('HP'), s('REGEN'), s('CRIT'), s('DBLSTRIKE'), a('agility')], powers: ['evasive', 'fleet'],
  ...
  { id: 'deepwellLeggings', base: 'Leggings', name: 'The Deepwell Weave', cls: 'mage', native: 'MP',
    mods: [s('SPELLPWR'), s('CDR'), s('CASTSPD'), s('REGEN'), s('MPKILL'), a('spirit')], powers: ['attuned', 'spellbound'],
  ...
  { id: 'gildedSeal', base: 'Signet', name: 'The Gilded Seal', cls: 'any', native: 'GOLDFIND',
    mods: [s('MAGICFIND'), s('XPGAIN'), s('IDMG'), s('ATK'), s('HP'), a('might')], powers: ['greedy', 'prospector'],
    flavor: 'every ring it stamps pays out, one way or another' },
  { id: 'lifebinderBand', base: 'Band', name: 'Lifebinder', cls: 'any', native: 'HP',
    mods: [s('REGEN'), s('DR'), s('TENAC'), s('HPKILL'), s('IDMG'), a('vitality')], powers: ['mending', 'stalwart'],
  ...
  { id: 'aetherLoop', base: 'Loop', name: 'The Aether Loop', cls: 'mage', native: 'SPELLPWR',
    mods: [s('MP'), s('CDR'), s('CASTSPD'), s('MCR'), s('CRITDMG'), a('spirit')], powers: ['spellbound', 'hasty'],
  ...
  { id: 'foolsFortune', base: 'Ring', name: 'Fool\'s Fortune', cls: 'any', native: 'CRIT',
    mods: [s('CRITDMG'), s('MAGICFIND'), s('GOLDFIND'), s('ACC'), s('IDMG'), a('luck')], powers: ['fortunate', 'keen'],
  ...
  { id: 'archmagesNecklace', base: 'Necklace', name: 'The Sevenfold Chain', cls: 'mage', native: 'SPELLPWR',
    mods: [s('CRIT'), s('MP'), s('CDR'), s('CASTSPD'), s('CRITDMG'), a('spirit')], powers: ['savage', 'spellbound'],
  ...
  { id: 'heartstone', base: 'Pendant', name: 'Heartstone', cls: 'any', native: 'DR',
    mods: [s('HP'), s('REGEN'), s('HPKILL'), s('THORNS'), s('TENAC'), a('vitality')], powers: ['stalwart', 'mending'],
  ...
  { id: 'magpiesEye', base: 'Talisman', name: 'The Magpie\'s Eye', cls: 'any', native: 'MAGICFIND',
    mods: [s('GOLDFIND'), s('XPGAIN'), s('MATFIND'), s('CRIT'), s('HP'), a('luck')], powers: ['salvager', 'fortunate'],
  ...
  { id: 'conquerorsChain', base: 'Amulet', name: 'The Conqueror\'s Chain', cls: 'any', native: 'IDMG',
    mods: [s('ATK'), s('CRIT'), s('HP'), s('PEN'), s('SKILLPWR'), a('might')], powers: ['brutish', 'brutal'],
  ...
  { id: 'quickpulse', base: 'Charm', name: 'The Quickpulse', cls: 'rogue', native: 'REGEN',
    mods: [s('SPD'), s('DODGE'), s('CRIT'), s('HPKILL'), s('ACC'), a('agility')], powers: ['fleet', 'mending'],
