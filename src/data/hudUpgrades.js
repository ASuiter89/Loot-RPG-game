...
// Ordered cheapest → priciest WITHIN each group so the essentials read first.

export const HUD_UPGRADES = [
  // ── HUD READOUTS — the heads-up-display overlay pieces. ──
  { key: 'vitals', name: 'Vital Readout', icon: 'ic_heart', price: 40, group: 'readout',
    hud: 'health & mana numbers',
    desc: 'Print the exact numbers on your health and mana bars.' },
  { key: 'floor', name: 'Depth Gauge', icon: 'feat_gate_red', price: 40, group: 'readout',
    hud: 'dungeon floor counter',
    desc: 'Show which floor you are on.' },
  { key: 'foes', name: 'Spyglass', icon: 'ui_foes', price: 60, group: 'readout',
    hud: 'foes-remaining counter',
    desc: 'Tally the foes still standing between you and the stairs.' },
  { key: 'difficulty', name: 'Omen Dial', icon: 'ic_up', price: 60, group: 'readout',
    hud: 'difficulty tier label',
    desc: 'Name the difficulty tier beside the floor.' },
  { key: 'chests', name: 'Treasure Tally', icon: 'chest', price: 90, group: 'readout',
    hud: 'chests-remaining counter',
    desc: 'Count the unopened chests left on the floor.' },
  { key: 'status', name: 'Warding Charm', icon: 'ic_orb', price: 100, group: 'readout',
    hud: 'status-effect icons',
    desc: 'Reveal your buff & debuff icons in the top corner.' },
  { key: 'minimap', name: "Cartographer's Map", icon: 'q_beacon', price: 150, group: 'readout',
    hud: 'minimap',
    desc: 'Sketch the whole floor as a corner minimap.' },
  // ── BAG & LOOT TOOLS — conveniences for reading and handling loot. ──
  { key: 'rankings', name: "Appraiser's Loupe", icon: 'ui_power', price: 50, group: 'bag',
    hud: 'item Power ratings',
    desc: 'Print each gear piece Power rating in your bag and worn slots.' },
  { key: 'compare', name: 'Gauging Calipers', icon: 'scroll', price: 75, group: 'bag',
    hud: 'quick stat compare',
    desc: 'Show the +/- stat swing of each item against your equipped gear.' },
  { key: 'sortfilter', name: "Quartermaster's Ledger", icon: 'ui_bag', price: 85, group: 'bag',
    hud: 'bag sort & filter',
    desc: 'Sort and filter your bag by rarity, Power, slot, value or stat.' },
  { key: 'autoloot', name: 'Sorting Sieve', icon: 'mat_scrap', price: 120, group: 'bag',
    hud: 'auto-loot rules',
    desc: 'Auto-scrap or auto-sell loot of chosen rarities the moment it drops.' },
];

// The two bench sections, in display order, with the section blurb the HUD-KIT bench
// prints above each group. The shell renders one .shop-grid per group.
