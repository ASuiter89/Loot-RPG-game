...
export const CHANGELOG = [
  { date: "2026-08-03", size: "medium", v: "Three new special item kinds; \"Cursed\" is a curse again", by: "Jeff Louie", notes: ["\"Cursed\" dropped as a plain name prefix — ordinary gear read as cursed with no drawback anywhere on it. Only the real curse is called cursed now; old saves rename to Gilded.", "Fortunate (~4%): one Gold or Magic Find roll 2.5×–5.5× past its ceiling, no drawback; protected from reroll.", "Deepforged (~3%): whole piece rolls +35% item level (min +5) — deep-floor numbers early, equip gate rises to match.", "Storied (~3%): full affix spread plus one property past the rarity cap; legendaries reach 6 stats.", "One kind per piece, green+ only, ~22% total; each marked by its own pixel icon, never by name."] },
