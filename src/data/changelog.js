...
export const CHANGELOG = [
  { date: "2026-08-05", size: "small", v: "Sprint runs longer, Stamina refills faster", by: "Jeff Louie", notes: ["Sprint drains 20/sec (was 34) — 5s from a full pool (was 2.9s); refill 30/sec (was 22).", "Dash 45 Stamina (was 35) — still 2 from full; quicker refill buys running, not dash-spam."] },
  ...
  { date: "2026-08-05", size: "medium", v: "Staff bolts and Mage openers stop draining the bar", by: "Jeff Louie", notes: ["Staff auto-attack 2 MP (was 4), now discounted by Mana Cost Reduction; free for no-mana heroes — a Bloodletter holding a Staff could never auto-attack at all.", "Mage openers re-priced for their 1s cadence: Firebolt/Frost Shard/Spark 3 MP (was 6), Arcane Missile 4 (was 7) — they demanded 6-7 MP/sec where every other class asks 1.7-3.5.", "gameState().player.boltCost reports what a Staff shot charges."] },
  { date: "2026-08-04", size: "medium", v: "Spells cost a third less; mana regen scales with your pool", by: "Jeff Louie", notes: ["Global 1.5× mana surcharge dropped — a skill charges its listed cost. Coin Toss r5 9 MP (was 14).", "Regen adds 3%/sec of max MP, so an empty bar refills in ~25s at every level (was 130s at 10, 480s at 60).", "In-combat regen 65% (was 50%).", "Auto-cast holds 30% of max MP back for your manual slots — mirrors the blood-caster's health reserve."] },
  ...
  { date: "2026-08-04", size: "large", v: "Guns for the Fortune-Seeker; every slot gates on all five attributes", by: "Jeff Louie", notes: ["New GUN weapons gate on Luck — Carbine (1H, reach 3) and Longrifle (2H, reach 4, widest damage band in the game); Fortune-Seeker and Rogue both wield them.", "Bespoke rifle art: world tile matches the spear/staff angle and shading, bag icon the upright weapon icons.", "Fortune-Seeker mains Luck but every ranged weapon wanted Agility, so its own stat bought it no weapon.", "New weapons: Runeblade (Sword, Spirit), Warhammer (Mace, Vitality) — Windblade and Templar each reach a weapon on their own attribute.", "New bases fill every gap: Greathelm (Might), Coat/Handwraps/Breeches (Luck), Coil (Agility), Spiked Shield (Might), Bandolier (Luck).", "Every slot now offers a base for each of the five attributes, and rolls +attr affixes for all five (was 3 per slot).", "11 new hand-crafted uniques, one per new base."] },
  { date: "2026-08-04", size: "medium", v: "Potency splits per flask; Blessings half price, priced by depth", by: "Jeff Louie", notes: ["Health Potency & Mana Potency are separate tracks, 5 ranks each; old ranks carry to both flasks.", "Blessings cost 50% less and scale with floor depth + average gold drop, not hero level; no cap.", "Floor 20 Might: 2.4k (was ~19k at level 20)."] },
  { date: "2026-08-04", size: "medium", v: "Auto-attacks learn to pierce, ricochet, split and rebound", by: "Jeff Louie", notes: ["Pierce: through 3 foes behind the mark. Ricochet: 3 hops, weaker each. Multishot: 2 extra strikes in reach. Rebound: ricochets carom off walls, no line needed.", "From 4 weapon powers — Piercing, Caroming, Volleying, Rebounding — and 18 passives across all 7 classes at rank 5/7.", "Extra hits roll own accuracy & crit, each weaker than the blow that spawned it; nothing to hit on a lone boss.", "Might: 2.95 auto damage/pt (was 2.6). Attack Speed rolls on rings. Double Strike scale 85 (was 100), rolls ~29% richer; Cleave ~24% richer.", "Hero sheet, item cards and gameState().player.offense.autoAttack report your shape."] },
  ...
  { date: "2026-08-03", size: "medium", v: "Each flask recharges on its own timer", by: "Jeff Louie", notes: ["Health & Mana potions no longer share a cooldown — a heal never locks out a mana sip.", "Healer sells a Recharge track per flask: 5 ranks, −0.4s each, 6s → 4s (was one track, 6 ranks, −0.5s).", "Old Recharge ranks carry over to both flasks."] },
