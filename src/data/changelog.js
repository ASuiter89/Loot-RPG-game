...
export const CHANGELOG = [
  { date: "2026-07-09", size: "medium", v: "Uniques can roll a second signature power", by: "Jeff Louie", notes: [
    "A unique artifact now has a 1-in-3 chance, rolled on drop, to carry a SECOND signature ✦ power stacked on its first — so some copies of a unique are notably stronger than others. It never rolls a third.",
    "Each unique's primary and its possible secondary are hand-picked to its theme and class, and stay on their lane — caster uniques never waste a weapon-only power, martial uniques never a spell-only one.",
    "Hover a unique — worn, in the bag, or as a Collection tile — to see its powers; the Collection preview flags the second as a 33% chance. gameState() lists a piece's rolled powers in its \"powers\".",
  ] },
  ...
  { date: "2026-07-06", size: "small", v: "Town Merchant description no longer mentions potions", by: "Jeff Louie", notes: [
  ...
  { date: "2026-07-06", size: "small", v: "Traps hit harder", by: "Jeff Louie", notes: [
    "Lava, spikes, arrow traps and fire vents all deal noticeably more damage, and scale up faster with depth — hazards are a real threat to route around now, not just a scratch.",
  ] },
  ...
  { date: "2026-07-05", size: "small", v: "Skills you can't afford grey out on the bar", by: "Jeff Louie", notes: [
    "A skill whose mana cost you can't currently pay now shows a greyed-out icon on the skill bar, so you can see at a glance what you can't cast — its tooltip says \"Not enough mana\".",
  ] },
  ...
  { date: "2026-07-05", size: "small", v: "Nothing can wall off a one-tile hallway", by: "Jeff Louie", notes: [
  ...
  { date: "2026-07-03", size: "small", v: "Fix: prisoner cells never sealed off", by: "Jeff Louie", notes: [
