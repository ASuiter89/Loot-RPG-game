...
export const CHANGELOG = [
  ...
  { date: "2026-08-03", size: "medium", v: "Each flask recharges on its own timer", by: "Jeff Louie", notes: ["Health & Mana potions no longer share a cooldown — a heal never locks out a mana sip.", "Healer sells a Recharge track per flask: 5 ranks, −0.2s each, 6s → 5s (was one track, 6 ranks, −0.5s).", "Old Recharge ranks carry over to both flasks."] },
