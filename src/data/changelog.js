...
export const CHANGELOG = [
  ...
  { date: "2026-08-04", size: "large", v: "Guns for the Fortune-Seeker; every slot gates on all five attributes", by: "Jeff Louie", notes: ["New GUN weapons gate on Luck — Flintlock (1H, reach 3) and Hand Cannon (2H, reach 4, widest damage band in the game); Fortune-Seeker favours them.", "Fortune-Seeker mains Luck but every ranged weapon wanted Agility, so its own stat bought it no weapon.", "New weapons: Runeblade (Sword, Spirit), Warhammer (Mace, Vitality) — Windblade and Templar each reach a weapon on their own attribute.", "New bases fill every gap: Greathelm (Might), Coat/Handwraps/Breeches (Luck), Coil (Agility), Spiked Shield (Might), Bandolier (Luck).", "Every slot now offers a base for each of the five attributes, and rolls +attr affixes for all five (was 3 per slot).", "11 new hand-crafted uniques, one per new base."] },
