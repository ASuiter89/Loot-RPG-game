...
describe('killLootParams — first-kill jackpot', () => {
  it('pays a windfall on a boss first kill: ~3x picks, +quality, slashed noDrop', () => {
    ...
    expect(p.noDrop).toBeCloseTo(0.20 * 0.35, 10);
